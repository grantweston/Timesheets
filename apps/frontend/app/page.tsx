...
const features = [
  {
    ...
    description:
      'Seamlessly track your work with our desktop app. No manual input required.',
  },
  {
    icon: Brain,
    title: 'AI-Powered Analysis',
    description:
      'Smart categorization and insights powered by advanced machine learning algorithms.',
  },
  {
    icon: FileText,
    title: 'Smart Invoicing',
    description:
      'Generate professional invoices with a single click. Integrate with your billing system.',
  },
  {
    icon: Shield,
    title: 'Privacy First',
...
const testimonials = [
  {
    quote:
      'TimeTrack AI has transformed how we handle time tracking. The AI categorization is incredibly accurate!',
  ...
  {
    quote:
      "The automatic time tracking has saved us countless hours. It's like having a personal assistant for time management.",
    author: 'Michael Chen',
...
const metrics = [
  {
    value: '85%',
    label: 'Time Saved',
    description: 'Reduction in manual time tracking',
  },
  {
    value: '99%',
    label: 'Accuracy',
    description: 'In AI-powered categorization',
  },
  {
    value: '24/7',
    label: 'Monitoring',
    description: 'Continuous activity tracking',
  },
          ...
          <section className="container space-y-8 py-12 lg:py-24">
            ...
            <div className="mx-auto flex max-w-[64rem] flex-col items-center gap-6 text-center">
              ...
              <p className="max-w-[42rem] text-lg leading-relaxed text-muted-foreground sm:text-xl">
                Effortlessly track time, generate invoices, and focus on what
                matters. Our AI-powered system handles the rest.
              </p>
              ...
              <div className="relative rounded-3xl border border-zinc-200 dark:border-zinc-800 bg-white/50 dark:bg-zinc-900/50 backdrop-blur-sm p-8 md:p-12 lg:p-16 overflow-hidden">
                ...
                <div className="relative space-y-4 text-center mb-12">
                  ...
                  <p className="text-lg text-muted-foreground max-w-[42rem] mx-auto">
                    Our intelligent system captures your work automatically and
                    uses AI to classify tasks and generate accurate timesheets.
                  </p>
                </div>
